                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="login-box bg-white box-shadow border-radius-10">
                            ...
                            <div class="login-title align-items-center">
                                <h2 class="text-center text-primary">MBachir - PMS</h2>
                                <p class="text-center mt-1 small">Portal de Entrada</p>
                            </div>
                            ...
                            <form>
                                ...
                                <div class="row pb-30">
                                    ...
                                    <div class="col-6">
                                        <div class="forgot-password"><a href="forgot-password.php">Esqueci a senha</a></div>
                                    </div>
                                </div>
